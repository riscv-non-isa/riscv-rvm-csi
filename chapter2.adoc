...
|csi_defs.h|API|Definitions of generic low-level functionality; including general-purpose definitions such as return codes.
|csi_csrs.h|API|Standard CSR definitions (auto-generated according to the RISC-V spec)
...
csi_csrs.h lists indices and bitfield information for all the standard RISC-V CSRs.  This file will be
